...
def give_char():
       ...
       test_image = image.load_img('tmp1.png', target_size=(224,224))
       ...
       if 0 <= indx < len(chars):
        ...
        # Handle the case where indx is out of range
...
op_dest="C:/Users/Parishee Agarwal/Desktop/Sign-Language-Detection--main/filtered_data/"
alpha_dest="C:/Users/Parishee Agarwal/Desktop/Sign-Language-Detection--main/alphabet/"
...
class VtoS(tk.Frame):
       def __init__(self, parent, controller):
              ...
              l1 = tk.Label(self,text = "TEXT TO BE CONVERTED")
              inputtxt = tk.Text(self, height = 4,width = 25)
              voice_button= tk.Button(self,height = 2,width = 20, text="Translate",command=lambda: hear_voice())
       ...
       def __init__(self, parent, controller):
        ...
        def start_video():
            ...
            def video_stream():
                ...
                tmp_text = img_text if img_text else ""
                img_text = give_char()
